...
### Data Science Student | AI & Machine Learning

🎓 **B.S. Data Science @ San José State University** • May 2027
...
Developed a deep learning pipeline on **395,000+ LendingClub records**, achieving **89% validation accuracy** for loan default prediction.
...
Used **K-Means and PCA** to identify four customer segments, reducing 17 features to 7 principal components while retaining **94% of dataset variance**.
